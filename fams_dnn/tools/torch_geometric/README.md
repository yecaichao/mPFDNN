...
This project uses a very small subset of [`pytorch_geometric`](https://pytorch-geometric.readthedocs.io/en/latest/) [1, 2], mainly the most basic graph data structures.
